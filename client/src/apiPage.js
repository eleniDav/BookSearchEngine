...
import pic1 from "./assets/google_books.png";
import pic2 from "./assets/google_books_api.png";
        ...
        <>
            <div className="searchBarContainer">
                <div className="otherPagesContainer">
                    ...
                    <div className="gb">
                        <a href="https://books.google.com/" target="_blank" rel="noreferrer"><img src={pic1} alt="" className="google"></img></a>
                    ...
                    <div className="gbapi">
                    <a href="https://developers.google.com/books" target="_blank" rel="noreferrer"><img src={pic2} alt="" className="google_api"></img></a>
